        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            ...
            {stats.qtyByUom.map((r) => (
              <StatCard key={r.uom} label={`Belum Diinput (${r.uom})`} value={r.qtyBelum || 0} tone="warn" />
            ))}
          ...
          {stats.qtyByUom.length > 0 && (
            <div className="card p-5">
              ...
              <p className="mt-2 text-xs text-ink/40">Angka "Belum Diinput" di atas otomatis berkurang tiap ada material baru yang diinput petugas.</p>
            </div>
          )}
