  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Session Stock Opname</h1>
          <p className="mt-1 text-sm text-ink/60">Pilih session yang sedang berjalan, atau buat session baru.</p>
        </div>
