...
export default function InputPage() {
  ...
  // Form "Revisi Kode Material" — jalur pintas yang selalu kelihatan di
  // banner recount (nggak perlu buka baris/riwayat material yang salah dulu
  // baru nemu tombolnya). Isi kode yang salah + kode yang benar sekaligus.
  ...
  function pickAsWrongCode(code) {
    ...
    setTimeout(() => revisionToInputRef.current?.focus(), 300);
  }
      ...
      {recountMode && (
        <div className="card border-warn/40 bg-warn/10 p-3.5 text-sm">
          ...
          <div ref={revisionFormRef} className="mt-3 rounded-lg border border-line bg-white p-2.5 text-xs">
            <div className="font-medium text-ink/70">Salah ketik material code? Revisi di sini →</div>
