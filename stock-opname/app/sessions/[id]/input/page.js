...
export default function InputPage() {
  ...
  // di atas, nggak perlu ketik/cari manual lagi.
  ...
  // Yang terjadi: entry AKTIF TERAKHIR milik kode yang salah dibatalkan,
  // lalu baris material yang BENAR langsung di-prefill dari data itu dan
  // dibuka di accordion — tinggal cek Batch lalu Simpan Rak.
  async function submitCodeRevision() {
    ...
    if (!entry) {
      ...
      setRakError(`${fromCode}: belum ada entry aktif untuk direvisi.`);
      return;
    }
    ...
    setRakInfo(`Entry "${fromCode}" sudah dibatalkan. Kartu "${toCode}" sudah kebuka di bawah — cek Batch-nya lalu Simpan Rak.`);
    setRevisionFromCode('');
    setRevisionToCode('');
    setRevisionReason('');
        ...
        <div className="card border-warn/40 bg-warn/10 p-3.5 text-sm">
          ...
          <div ref={revisionFormRef} className="mt-3 rounded-lg border border-line bg-white p-2.5 text-xs">
            ...
            <textarea
              ...
              placeholder="Alasan: contoh salah ketik, seharusnya ABGTB2201"
            />
            <button
              type="button"
            ...
            <p className="mt-1.5 text-ink/40">
              Ini otomatis batalkan entry aktif terakhir dari kode yang salah, lalu buka kartu kode yang benar
              buat langsung diisi Batch/Qty-nya.
            </p>
          </div>
