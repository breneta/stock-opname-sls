...
export default function SelisihPage() {
  ...
  async function load() {
    ...
    // Legacy plain string[] (from before source-tagging existed) carries no
    // source info — treat as empty here rather than guessing.
    const approved = codes.length > 0 && typeof codes[0] === 'object' ? codes : [];
