...
export default function RimpilanInputPage() {
  ...
  // Same snapshot idea as Normal SO's input page — Qty SAP/Tercatat/Selisih
  // taken by Accounting the moment "Mulai Recount" was clicked, shown only
  // here (recount mode), never during a first/blind count.
  ...
  async function load() {
    ...
    if (sessionData) {
      ...
      setRecountSnapshots(Object.fromEntries(eligibleCodes.map((c) => [c.code, {
